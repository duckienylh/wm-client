...
import { AppAreaInstalled, AppWelcome, AppWidgetSummary } from '../index';
import AppSaleRevenueByWeekChartLine from '../AppSaleRevenueByWeekChartLine';
...
export default function AdminGeneralApp() {
  const { user } = useAuth();
