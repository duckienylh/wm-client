      ...
      <Card sx={{ pt: 5, px: 5 }}>
        <Grid container>
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <Image disabledEffect visibleByDefault alt="logo" src="/static/logo.svg" sx={{ maxWidth: 120 }} />
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{sale.address}</Typography>
            <Typography variant="body2">Phone: {sale.phone}</Typography>
          </Grid>
